...
function reset_state() {
    ...
    mysubmit.title = "Add to MusicBrainz as release";
    ...
    text.innerText = "Add to MusicBrainz";

    mysubmit.appendChild(icon);
    mysubmit.appendChild(text);
